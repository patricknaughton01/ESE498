...
rst -system
after 3000
targets -set -filter {jtag_cable_name =~ "Digilent Zed 210248A39974" && level==0} -index 1
...
targets -set -nocase -filter {name =~"APU*"}
loadhw -hw /home/patricknaughton01/Documents/WashU/School/Sem6/ESE498/tdc/tdc.vitis/monitor_hw2/export/monitor_hw2/hw/design_1_wrapper.xsa -mem-ranges [list {0x40000000 0xbfffffff}]
