...
HD_PWD='/home/patricknaughton01/Documents/WashU/School/Sem6/ESE498/tdc/tdc.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log virus.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source virus.tcl
